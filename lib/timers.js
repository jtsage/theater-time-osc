...
class Timer extends EventEmitter {
	...
	#loadJSON(filename) {
		...
		for ( const thisSwitch of thisLoad.switches ) {
			this.addSwitch(thisSwitch.title, thisSwitch.onText, thisSwitch.offText, thisSwitch?.startOn ?? false, thisSwitch?.audioFile ?? null)
		}
	...
	addSwitch(title, onText, offText, isOn = false, audioFile = null) {
	...
	audioPlaySwitch(index) {
		if ( this.#switches[index].audio !== null ) {
			sound.play(
				path.join(__dirname, '..', 'sound_clips', 'chimes.wav'),
				this.#audio.audioVol
			).then(() => {
...
class Switch {
	...
	constructor(id, title = null, onText = null, offText = null, isOn = false, audioFile = null) {
		this.#id        = id
		this.#isOn      = isOn
		this.#title     = title
